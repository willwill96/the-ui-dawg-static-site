...
<img
  src={convertToBaseUrl('version-with-changesets/changesets-banner.png')}
/>
...
<img
  src={convertToBaseUrl('version-with-changesets/run-changeset.png')}
/>
...
<img
  src={convertToBaseUrl('version-with-changesets/changeset-status.png')}
/>
...
<img
  src={convertToBaseUrl('version-with-changesets/phased-approach.png')}
/>
