...
<img
  src={convertToBaseUrl('install-via-git/thumbnail.jpg')} 
/>
...
<img
  src={convertToBaseUrl('install-via-git/install-example.png')}
/>

<img
  src={convertToBaseUrl('install-via-git/usage-example.png')}
/>
...
<img
  src={convertToBaseUrl('install-via-git/typescript-fail.png')}
/>
...
<img
  src={convertToBaseUrl('install-via-git/typescript-success.png')}
/>
